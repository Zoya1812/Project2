...
selectReviewsLoadingStatus(state) === REQUEST_STATUSES.pending;

export const selectIsReviewsLoaded = (state) => 
selectReviewsLoadingStatus(state) === REQUEST_STATUSES.success;